...
def create_parser():
    ...
    parser.add_argument("--incremental_learning", action='store_true', help="Use incremental learning on a trained model. Note that args.unique_name needs to point to the pre-trained model.")
...
def save_pred(f1, pred, ground_truth, save_path):
    content = {
        "f1": f1, 
        "pred": pred, 
    ...
    np.save(save_path, content, allow_pickle=True)